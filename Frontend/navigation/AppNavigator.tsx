...
import HelpScreen from "../screens/HelpScreen"; // nowa trasa
...
export type StackParamList = {
  ...
  OrderDetails: { workId: string; clientId: number; userRole: string; userName: string };
  ConstructionOrderDetails: { workId: string; workerId: number; userType: string; userRole: string; userName: string };
  ...
  CostSummary: { constructionType: string; specificationDetails: SpecificationDetails; includeTax: boolean; totalCost: number; clientId: number; userRole: string; userName: string };
  OrderMaterial: { material: Material; clientId: number; userRole: string; userName: string };
  ConstructionOrder: { description: string | null; constructionType: string; specificationDetails: SpecificationDetails; placementPhotos: string[] | null; requestedStartTime: string | null; clientProposedPrice: number; clientId: number; userRole: string; userName: string };
  MyMaterials: { clientId: number; userRole: string; userName: string };
  NegotiationDetails: { negotiation: Negotiation; clientId: number; userRole: string; userName: string };
  NegotiationCounter: { negotiationId: string; clientProposedPrice: number; workerProposedPrice: number; clientId: number; userRole: string; userName: string };
  HelpScreen: { userRole: string; userName: string; clientId: number }; // nowa trasa
};
