...
const MATERIAL_ENUM1 = { //PartitionWall
  Drywall: 0,
  Brick: 1,
  AeratedConcrete: 2,
  Wood: 3,
...
const INSULATION_TYPE_ENUM = { //Facade
  Styrofoam: 0,
  MineralWool: 1,
  PolyurethaneFoam: 2,
  Fiberglass: 3,
...
const FINISH_MATERIAL_ENUM = { //Facade
  Plaster: 0,
  Brick: 1,
  Stone: 2,
  Wood: 3,
...
const MATERIAL_ENUM7 = { //SuspendedCeiling
  Drywall: 0,
  MineralFiber: 1,
  Metal: 2,
  PVC: 3,
...
const MATERIAL_ENUM8 = { // InsulationOfAttic
  MineralWool: 0,
  Styrofoam: 1,
  PolyurethaneFoam: 2,
  Cellulose: 3,
...
const MATERIAL_ENUM9 = { // Plastering
  Gypsum: 0,
  Cement: 1,
  Lime: 2,
  LimeCement: 3,
...
const MATERIAL_ENUM10 = { // Painting
  Acrylic: 0,
  Latex: 1,
  OilBased: 2,
  WaterBased: 3,
...
const MATERIAL_ENUM11 = { // Staircase
  Unknown: 0,
  Wood: 1,
  Metal: 2,
  Concrete: 3,
...
const MATERIAL_ENUM13 = { // LoadBearingWall
  Concrete: 0,
  Brick: 1,
  AeratedConcrete: 2,
  Stone: 3,
...
const CalculatorScreen: React.FC = () => {
  ...
  const handleCalculate = () => {
    ...
    const calculatedPrice = 1000; // Placeholder logic for price calculation
  ...
  const renderFields = () => {
    switch (state.constructionType) {
        ...
        return (
          <>
            ...
            <TextInput
              ...
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Height: parseFloat(text) } })
              }
            />
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Width: parseFloat(text) } })
              }
            />
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Thickness: parseFloat(text) } })
              }
            />
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                onValueChange={(value) =>
                  setState({ ...state, fields: { ...state.fields, Material: value } })
                }>
        ...
        <>
          <Text style={styles.label}>Length (m)</Text>
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Length: parseFloat(text) } })
              }
            />
            <Text style={styles.label}>Width (m)</Text>
            <TextInput
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Depth: parseFloat(text) } })
              }
            />
        </>
      );
        ...
        <>
          <Text style={styles.label}>Amount</Text>
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Amount: parseFloat(text) } })
              }
            />
            <Text style={styles.label}>Height (m)</Text>
            <TextInput
      ...
      return (
        <>
          ...
          <TextInput
            ...
            keyboardType="numeric"
            onChangeText={(text) =>
              setState({ ...state, fields: { ...state.fields, SurfaceArea: parseFloat(text) } })
            }
          />
          ...
          <View style={styles.pickerContainer}>
            <Picker
              ...
              onValueChange={(value) =>
                setState({ ...state, fields: { ...state.fields, InsulationType: value } })
              }>
          ...
          <View style={styles.pickerContainer}>
            <Picker
              ...
              onValueChange={(value) =>
                setState({ ...state, fields: { ...state.fields, FinishMaterial: value } })
              }>
      ...
      return (
        <>
          ...
          <TextInput
            ...
            keyboardType="numeric"
            onChangeText={(text) =>
              setState({ ...state, fields: { ...state.fields, Area: parseFloat(text) } })
            }
          />
          <Text style={styles.label}>Material</Text>
          <View style={styles.pickerContainer}>
      ...
      return (
        ...
        return (
          <>
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, WallSurfaceArea: parseFloat(text) } })
              }
            />
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                onValueChange={(value) =>
                  setState({ ...state, fields: { ...state.fields, PlasterType: value } })
                }
              >
          ...
          <>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                onValueChange={(value) =>
                  setState({ ...state, fields: { ...state.fields, PaintType: value } })
                }>
                <Picker.Item label="Acrylic" value="Acrylic" />
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, NumberOfCoats: parseInt(text, 10) } })
              }
            />
          </>
        );
        ...
        return (
          <>
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, NumberOfSteps: parseInt(text, 10) } })
              }
            />
            <Text style={styles.label}>Height (m)</Text>
            <TextInput
          ...
          <>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                onValueChange={(value) =>
                  setState({ ...state, fields: { ...state.fields, RailingMaterial: value } })
                }>
                <Picker.Item label="Steel" value="Steel" />
                <Picker.Item label="Wood" value="Wood" />
                <Picker.Item label="Glass" value="Glass" />
        ...
        return (
          <>
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Count: parseInt(text, 10) } })
              }
            />
          </>
        );
        ...
        return (
          <>
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Count: parseInt(text, 10) || 0 } })
              }
            />
          </>
        );
        ...
        return (
          <>
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Area: parseFloat(text) || 0 } })
              }
            />
            ...
            <TextInput
              ...
              keyboardType="numeric"
              onChangeText={(text) =>
                setState({ ...state, fields: { ...state.fields, Pitch: parseFloat(text) || 0 } })
              }
            />
            <Text style={styles.label}>Material</Text>
            <View style={styles.pickerContainer}>
        ...
        default:
        return <Text style={styles.label}>No fields available for this type.</Text>;
    }
  };
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.pickerContainer}>
        <Picker
          ...
          onValueChange={(value) =>
            setState({ ...state, constructionType: value as keyof typeof CONSTRUCTION_TYPE_ENUM, fields: {} })
          }>
      ...
      <View style={styles.switchContainer}>
        <Text style={styles.switchLabel}>{state.includeTax ? 'With Tax' : 'Without Tax'}</Text>
        <Switch
