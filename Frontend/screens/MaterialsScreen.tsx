...
const MaterialsScreen: React.FC = () => {
  ...
  // Sprawdzamy, czy parametry zostały przekazane
  ...
  // Przy kliknięciu "Order" przekazujemy obiekt material oraz dynamiczny clientId
    ...
    <View style={styles.materialCard}>
      <View style={styles.cardLeft}>
        ...
        <View style={{ flex: 1 }}>
          ...
          <Text style={styles.price}>Price without taxes: {item.priceWithoutTax} $</Text>
        </View>
      </View>
